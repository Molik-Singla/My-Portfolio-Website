...
const About = () => {
    return (
        <div className="box-border flex h-auto w-full flex-col bg-white px-8 pb-20 pt-10 sm:px-12 md:flex-col lg:px-16">
            ...
            <div className="box-border flex h-full w-full flex-col md:flex-row md:pt-6">
                ...
                {/* 2 */}
                <div className="box-border w-full pt-7 md:w-1/2">
